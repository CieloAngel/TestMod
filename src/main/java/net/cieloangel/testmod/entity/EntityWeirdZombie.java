package net.cieloangel.testmod.entity;
...
public class EntityWeirdZombie extends EntityMob {
	...
	// Reuse the zombie model which has arms that need to be raised when the zombie is attacking:
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MOD_ID, "entities/weird_zombie");
