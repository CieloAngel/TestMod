...
//
//public class BlockModPortal extends BlockBase {
//	
...
//		this.setUnlocalizedName("block_portal_plain");
...
////            {
////                Entity entity = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.getEntityID(WeirdZombie.class), (double)blockpos.getX() + 0.5D, (double)blockpos.getY() + 1.1D, (double)blockpos.getZ() + 0.5D);
////
////                if (entity != null)
////                {
...
//    {
//        BlockModPortal.Size blockportal$size = new BlockModPortal.Size(worldIn, pos, EnumFacing.Axis.X);
//
...
//        else
//        {
//            BlockModPortal.Size blockportal$size1 = new BlockModPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
//
